  ...
  return (
    ...
    >
        <Box display='flex' flexDirection='column' gap='40px' justifyContent='center' alignItems='center'>
            ...
            <Typography variant='h1' fontWeight='600' fontSize='35px'>Sign in to AnalytiXpert</Typography>
            <Box display='grid' width='360px' gap='20px' justifyContent='center'>
                ...
                <Typography sx={{color: 'rgba(0,0,0,0.7)', marginTop: '20px'}}>New to AnalytiXpert? <Link sx={{color: 'secondary.main', ":hover": {cursor: 'pointer'}}} onClick={() => navigate('/sign-in')}>Create an account</Link></Typography>
            </Box>
        </Box>
    </Box>
